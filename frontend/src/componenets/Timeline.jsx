...
const ResponsiveTimeline = () => {
  ...
  return (
    <motion.div
      className='timeline1'
      style={{ position: 'relative', maxWidth: '768px', margin: '0 auto', padding: '48px 16px' }}
      initial="hidden"
      whileInView="visible"
    ...
    >
      ...
      <motion.div style={{ display: 'flex', flexDirection: 'column', gap: '80px' }}>
        {timelineData.map((item, index) => (
          ...
          >
            ...
            >
              ...
              >
                <h3 className="text-lg font-bold text-purple-400 mb-1">{item.title}</h3>
