...
import ShopNestdemo from "../assets/ShopNestdemo.mp4";
import Vibeshare from "../assets/Vibeshare.mp4";
const Skills = () => {
  return (
    <div
    ...
    >
      ...
      bg-transparent shadow-purple-500 shadow-sm flex items-center flex-col rounded-3xl hover:shadow-md hover:-translate-y-3 transform transition-all duration-300 ease-in-out backdrop-blur-xs"
        ...
        <motion.div
          ...
          transition={{ duration: 0.5 }}
        >
          <a href="https://github.com/Rishabhjain610/VibeShare">
            <SpotlightCard
              className="custom-spotlight-card h-[850px] w-[300px] sm:h-[900px] sm:w-[350px] xl:h-[700px] xl:w-[350px]
        bg-transparent shadow-purple-500 shadow-sm flex items-center flex-col  rounded-3xl hover:shadow-md hover:-translate-y-3 transform transition-all duration-300 ease-in-out backdrop-blur-xs"
              spotlightColor="rgba(139, 92, 246, 0.15)"
            ...
            >
              ...
              <h1 className="font1 text-3xl ">
                Vibe<span className="text-purple-500">Share</span>
              </h1>
              <p
                style={{
                  margin: "10px 20px",
                ...
                className="font1 text-gray-300"
              >
                VibeShare is a dynamic MERN stack social media platform
                integrating real-time messaging, reels, and stories. It features
                advanced AI chat summarization to streamline conversations,
                ensuring a fast, engaging, and modern community experience for
                all users.
              </p>
              ...
              <div style={{ margin: "10px 20px 0px 20px" }}>
                ...
                <a
                  href="https://github.com/Rishabhjain610/VibeShare"
                  className="flex items-center justify-center  text-gray-300 hover:text-purple-500 transition-colors duration-300"
                >
                  <div className="flex items-center justify-center">
                    <SiGithub
        ...
        <motion.div
          ...
          transition={{ duration: 0.5 }}
        >
          <a href="https://github.com/Rishabhjain610/ShopNest">
            <SpotlightCard
              className="custom-spotlight-card h-[850px] w-[300px] sm:h-[900px] sm:w-[350px] xl:h-[700px] xl:w-[350px]
        bg-transparent shadow-purple-500 shadow-sm flex items-center flex-col  rounded-3xl hover:shadow-md hover:-translate-y-3 transform transition-all duration-300 ease-in-out backdrop-blur-xs"
              spotlightColor="rgba(139, 92, 246, 0.15)"
            ...
            >
              ...
              <h1 className="font1 text-3xl ">
                Shop<span className="text-purple-500">Nest</span>
              </h1>
              <p
                style={{
                  margin: "10px 20px",
                ...
                className="font1 text-gray-300"
              >
                ShopNest is a MERN-based Multilingual clothing E-commerce
                platform with Gemini AI, Twilio notifications, and an admin
                dashboard for product, order, and analytics management.
              </p>
              ...
              <div style={{ margin: "10px 20px 0px 20px" }}>
                ...
                <a
                  href="https://github.com/Rishabhjain610/ShopNest"
                  className="flex items-center justify-center  text-gray-300 hover:text-purple-500 transition-colors duration-300"
                >
                  <div className="flex items-center justify-center">
                    <SiGithub
        ...
        bg-transparent shadow-purple-500 shadow-sm flex items-center flex-col  rounded-3xl hover:shadow-md hover:-translate-y-3 transform transition-all duration-300 ease-in-out backdrop-blur-xs"
            ...
            >
              ...
              <p
                ...
                className="font1 text-gray-300"
              >
                ClearChat is a full-stack MERN real-time chat app using Redux
                for state management, JWT auth, Socket.IO messaging, Multer &
                Cloudinary media uploads, emoji support, and a responsive
                Tailwind UI.
              </p>
