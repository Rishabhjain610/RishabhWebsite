...
const Contact = () => {
  ...
  return (
    ...
    >
      ...
      >
        <motion.div
          className="w-full bg-transparent backdrop-blur-xs border-1 border-purple-500 rounded-2xl hover:shadow-md shadow-purple-500 "
          style={{ margin: "20px 50px", padding: "40px 20px" }}
          initial={{ opacity: 0, x: -100 }}
          whileInView={{ opacity: 1, x: 0 }}
          transition={{ duration: 0.5 }}
        >
          ...
          >
            <motion.a
              ...
              className="bg-purple-500 hover:bg-purple-600 text-white rounded-lg  flex items-center justify-center gap-2 min-h-[60px] transition-all duration-300"
              variants={buttonVariants}
            ...
            >
              ...
              <span className="hidden lg:flex font1 text-lg font-medium">LinkedIn</span>
            </motion.a>
            ...
            <motion.a
              ...
              className="bg-purple-500 hover:bg-purple-600 text-white rounded-lg p-4 flex items-center justify-center gap-2 min-h-[60px] transition-all duration-300"
              variants={buttonVariants}
              whileHover="hover"
              whileTap="tap"
            >
              ...
              <span className="hidden lg:flex font1 text-lg font-medium">GitHub</span>
            </motion.a>
            ...
            >
              ...
              <span className="hidden lg:flex font1 text-lg font-medium">WhatsApp</span>
            </motion.a>
            ...
            >
              ...
              <span className="hidden lg:flex font1 text-lg font-medium">Instagram</span>
            </motion.a>
            ...
            >
              ...
              <span className="hidden lg:flex font1 text-lg font-medium">Telegram</span>
            </motion.a>
            ...
            >
              ...
              <span className="hidden lg:flex font1 text-lg font-medium">Email</span>
            </motion.a>
          </motion.div>
        </motion.div>
