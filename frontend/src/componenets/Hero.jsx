...
const Hero = () => {
  ...
  return (
    <section
      id="home"
      className="relative flex flex-col items-center justify-center min-h-[150vh] md:min-h-screen px-4 py-20 overflow-hidden text-white"
    >
      <div
        ref={containerRef}
      ...
      >
        ...
        <div className="flex flex-col md:flex-row items-center justify-between">
          <div
            className="w-full relative top-[-40px] md:top-[20px] md:w-3/5 mb-12 md:mb-0"
