...
//     <section
//       id="home"
//       className="relative flex flex-col items-center justify-center min-h-[150vh] md:min-h-screen px-4 py-20 overflow-hidden text-white bg-gradient-to-b
//       from-transparent to-purple-900/17"
//     >
//       <div
//         ref={containerRef}
...
//               />
//               <motion.div
//                 className="absolute top-50 left-1/3 w-40 h-40 bg-pink-500 rounded-full opacity-10 filter blur-lg"
...
//           <motion.div
//             className="w-full md:w-3/5 mb-12 md:mb-0 space-y-6"
//             initial="hidden"
...
//             <motion.div
//               className="text-xl md:text-3xl font-semibold text-gray-300 h-14 font1"
//               variants={childVariant}
//               style={{
//                 marginTop: "10px",
//               }}
...
//             <motion.div
//               className="flex flex-col sm:flex-row gap-4 sm:gap-8 pt-8"
//               style={{
//                 marginTop: "20px",
//                 marginBottom: "20px",
//               }}
...
//               <motion.a
//                 href="#contact"
//                 className="w-full sm:w-auto text-center px-6 py-3 bg-purple-500 hover:bg-purple-600 text-white rounded-lg font-medium transition-all duration-300 font1 shine-effect button-pulse"
//                 whileHover={{
//                   scale: 1.05,
...
//               <motion.a
//                 href="#projects"
//                 className="w-full sm:w-auto text-center px-6 py-3 border border-purple-500 text-purple-500 hover:bg-purple-500 hover:text-white rounded-lg font-medium transition-all duration-300 font1 shine-effect"
//                 whileHover={{
//                   scale: 1.05,
...
//               </motion.a>
//             </motion.div>
//             <motion.div className="flex gap-6 pt-6">
//               <motion.a
